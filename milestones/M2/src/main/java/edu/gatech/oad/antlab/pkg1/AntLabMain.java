...
public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        Person1 p1 = new Person1("Kelvin Chen");
        toPrint += p1.toString("kchen330");
        //Person2 replace P2 with your name
        //and gburdell with your gt id
        Person2 p2 = new Person2("Lily Li");
        toPrint += p2.toString("dli319");
        //Person3 replace P3 with your name
        //and gburdell3 with your gt id
        Person3 p3 = new Person3("Young Hoon Cho");
        toPrint += p3.toString("ycho303");
        //Person4 replace P4 with your name
        //and gburdell4 with your gt id
        Person4 p4 = new Person4("David Riazati");
        toPrint += p4.toString("driazati3");
        //Person5 replace P4 with your name
        //and gburdell5 with your gt id
        Person5 p5 = new Person5("Chuan Yui Teh");
        toPrint += p5.toString("cteh6");
